<script lang="ts">
    ...
    const handleWidgetPaste = () => {
        ...
        let copiedWidget: any = sessionStorage.getItem("copiedWidget");
        ...
        try {
            ...
            getApiData(`${baseUrl}/api/v2/widgets`, "PUT", payload).then((w) => {
                ...
                sessionStorage.removeItem("copiedWidget");
...
<button on:click={handleWidgetPaste}>
    <Icon icon="ooui:paste-ltr"/>
    Paste
</button>
