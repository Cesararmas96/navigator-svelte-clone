	...
	theme: {
		...
		extend: {
			colors: {
				...
				primary: {
					DEFAULT: "rgb(var(--theme-color) / <alpha-value>)",
					50: "rgb(var(--theme-color) / 0.1)",
					100: "rgb(var(--theme-color) / 0.2)",
					200: "rgb(var(--theme-color) / 0.3)",
					300: "rgb(var(--theme-color) / 0.4)",
					400: "rgb(var(--theme-color) / 0.7)",
					500: "rgb(var(--theme-color) / 0.8)",
					600: "rgb(var(--theme-color) / 0.9)",
					700: "rgb(var(--theme-color) / 1)",
				},
				light: {
